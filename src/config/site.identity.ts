export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'miguelbuet',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Miguelbuet',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'miguelbuet.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://miguelbuet.com',
