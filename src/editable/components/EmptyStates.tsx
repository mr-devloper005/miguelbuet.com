...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-dashed border-current/15 bg-current/[0.03] p-10 text-center', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full border border-current/20 px-5 py-3 text-sm font-semibold transition hover:border-current/40 hover:bg-current/10">
        {actionLabel}
