...
// Shared warm editorial palette — kept in sync with design-contract.ts.
// Every task inherits it; only kicker/note text varies per task.
const base = {
  dark: false,
  fontDisplay: "'IBM Plex Serif', 'Fraunces', Georgia, serif",
  fontBody: YELP_FONT,
  bg: '#f7f7f2',
  surface: '#fcfbf7',
  raised: '#efede7',
